...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // $message = "You have received a new enrollment submission:\n\n";
    ...
    // $message .= "Time Preference: $time\n";
    // $message .= "Acting Experience: $experience\n"; 
    ...
    try {
        ...
        $mail->isHTML(true);
        // Set the email body (HTML formatted)
        $mail->Body    = $message;
        // Set the AltBody as plain text for non-HTML email clients
        ...
        $phone = "2349135770064";  
        $apiKey = "2838246"; 
        $whatsapp_message = "Filosofi Registration. Check your email *registration@ideaiscapital.com*"; 
